...
func newFollow(db *gorm.DB, opts ...gen.DOOption) follow {
	...
	_follow.UID = field.NewInt32(tableName, "uid")
	_follow.FollowUID = field.NewInt32(tableName, "follow_uid")
	_follow.FollowTime = field.NewTime(tableName, "follow_time")
...
type follow struct {
	...
	ALL        field.Asterisk
	ID         field.Int32
	UID        field.Int32 // 被关注的uid
	FollowUID  field.Int32 // 关注者的uid
	FollowTime field.Time
...
func (f *follow) updateTableName(table string) *follow {
	...
	f.FollowUID = field.NewInt32(table, "follow_uid")
	f.FollowTime = field.NewTime(table, "follow_time")
...
func (f *follow) fillFieldMap() {
	...
	f.fieldMap["follow_time"] = f.FollowTime
}
